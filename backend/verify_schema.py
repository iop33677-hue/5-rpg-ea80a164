...
import os
os.environ["DATABASE_URL"] = 'postgresql://neondb_owner:npg_YVwhDxtn91Kz@ep-wild-pine-aeaj826i.c-2.us-east-2.aws.neon.tech/neondb?sslmode=require'
...
engine = create_engine('postgresql://neondb_owner:npg_YVwhDxtn91Kz@ep-wild-pine-aeaj826i.c-2.us-east-2.aws.neon.tech/neondb?sslmode=require')
try:
